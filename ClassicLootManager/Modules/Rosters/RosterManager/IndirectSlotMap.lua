...
local IndirectMap = {
    slot = {
        ...
        --- SOD P8 ---
        [239709] = "INVTYPE_LEGS",      -- Consecrated Legplates
        [239731] = "INVTYPE_CHEST",     -- Consecrated Tunic
        [239726] = "INVTYPE_FEET",      -- Consecrated Boots
        [239707] = "INVTYPE_HEAD",      -- Consecrated Helmet
        [239716] = "INVTYPE_HAND",      -- Consecrated Gloves
        [239715] = "INVTYPE_CHEST",     -- Consecrated Robe
        [239721] = "INVTYPE_LEGS",      -- Consecrated Leggings
        [239759] = "INVTYPE_WRIST",     -- Consecrated Bracers
        [239760] = "INVTYPE_WAIST",     -- Consecrated Waistguard
        [239708] = "INVTYPE_SHOULDER",  -- Consecrated Pauldrons
        [239706] = "INVTYPE_FEET",      -- Consecrated Sabatons
        [239730] = "INVTYPE_HAND",      -- Consecrated Handguards
        [239714] = "INVTYPE_HEAD",      -- Consecrated Circlet
        [239762] = "INVTYPE_HAND",      -- Consecrated Gauntlets
        [239756] = "INVTYPE_WAIST",     -- Consecrated Girdle
        [239758] = "INVTYPE_SHOULDER",  -- Consecrated Spaulders
        [239757] = "INVTYPE_LEGS",      -- Consecrated Legguards
        [239719] = "INVTYPE_WRIST",     -- Consecrated Bindings
        [239710] = "INVTYPE_FEET",      -- Consecrated Sandals
        [239718] = "INVTYPE_WAIST",     -- Consecrated Belt
        [239761] = "INVTYPE_CHEST",     -- Consecrated Breastplate
    ...
    ilvl = {
        ...
        --- SOD P8 ---
        [239709] = 98,  -- Consecrated Legplates
        [239731] = 98,  -- Consecrated Tunic
        [239726] = 98,  -- Consecrated Boots
        [239707] = 98,  -- Consecrated Helmet
        [239716] = 98,  -- Consecrated Gloves
        [239715] = 98,  -- Consecrated Robe
        [239721] = 98,  -- Consecrated Leggings
        [239759] = 98,  -- Consecrated Bracers
        [239760] = 98,  -- Consecrated Waistguard
        [239708] = 98,  -- Consecrated Pauldrons
        [239706] = 98,  -- Consecrated Sabatons
        [239730] = 98,  -- Consecrated Handguards
        [239714] = 98,  -- Consecrated Circlet
        [239762] = 98,  -- Consecrated Gauntlets
        [239756] = 98,  -- Consecrated Girdle
        [239758] = 98,  -- Consecrated Spaulders
        [239757] = 98,  -- Consecrated Legguards
        [239719] = 98,  -- Consecrated Bindings
        [239710] = 98,  -- Consecrated Sandals
        [239718] = 98,  -- Consecrated Belt
        [239761] = 98,  -- Consecrated Breastplate
